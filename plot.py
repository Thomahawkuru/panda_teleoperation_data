...
ax2.boxplot(failed_grabs, whis=[0, 100])
...
ax3.boxplot(correct_grabs, whis=[0, 100])
...
ax4.boxplot(average_velocity, whis=[0, 100])
...
ax5.boxplot(input_depth, whis=[0, 100])
...
ax6.boxplot(grab_attempts, whis=[0, 100])
