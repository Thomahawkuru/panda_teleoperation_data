...
functions.tablesubplot(ax4[0], p_grab_fails, 'Failed Grabs')
functions.tablesubplot(ax4[1], p_grab_succes, 'Correct grabs')
functions.tablesubplot(ax4[2], p_grab_attemts, 'Grab attempts')
functions.tablesubplot(ax4[3], p_input_velocity, 'Input Velocity')
functions.tablesubplot(ax4[4], p_input_depth, 'Input depth')
